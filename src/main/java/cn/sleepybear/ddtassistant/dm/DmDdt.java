...
import cn.sleepybear.ddtassistant.utils.KeyPadUtil;
...
public class DmDdt extends Dm {
    ...
    public void bind(DmConstants.BindWindowMouseTypeEnum mouse, DmConstants.BindWindowKeypadTypeEnum keypad) {
        bind(mouse.getType(), keypad.getType());
    }
