...
public class Dm {
    ...
    public void bindWindow(int hwnd, DmConstants.BindWindowDisplayTypeEnum display, DmConstants.BindWindowMouseTypeEnum mouse, DmConstants.BindWindowKeypadTypeEnum keypad, int mode) {
        bindWindow(hwnd, display.getType(), mouse.getType(), keypad.getType(), mode);
    }

    public void bindWindow(int hwnd, DmConstants.BindWindowDisplayTypeEnum display, DmConstants.BindWindowMouseTypeEnum mouse, DmConstants.BindWindowKeypadTypeEnum keypad) {
        bindWindow(hwnd, display.getType(), mouse.getType(), keypad.getType(), 0);
    }

    public void bindWindow(Integer hwnd) {
        bindWindow(hwnd, DmConstants.BindWindowDisplayTypeEnum.DX2, DmConstants.BindWindowMouseTypeEnum.WINDOWS, DmConstants.BindWindowKeypadTypeEnum.WINDOWS, 0);
    }

    public void bindWindow(Integer hwnd, String mouse, String keypad) {
        bindWindow(hwnd, DmConstants.BindWindowDisplayTypeEnum.DX2.getType(), mouse, keypad, 0);
    }

    public void bindWindow(Integer hwnd, DmConstants.BindWindowMouseTypeEnum mouse, DmConstants.BindWindowKeypadTypeEnum keypad) {
        bindWindow(hwnd, DmConstants.BindWindowDisplayTypeEnum.DX2, mouse, keypad, 0);
    }
    ...
    public int[] enumWindow(int parent, String title, String className, int filter) {
        ...
        variant.safeRelease();
        if (hwndStrings == null || hwndStrings.isEmpty()) {
            return null;
        }
